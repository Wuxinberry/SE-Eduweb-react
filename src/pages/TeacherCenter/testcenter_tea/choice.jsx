...
handleanswer = e=> {
  ...
  render() {
    ...
    <Layout>
      ...
      <Layout>
      <div style={{color:'black',fontSize: '2.0em',marginLeft: 200}}>选择题编辑</div>
      <Content >
     ...
     <div style={{ marginLeft:  250 }}>请输入A选项
         {/* 选项 */}
      <TextArea rows={2} type="text" value={this.state.A} onChange={this.handleA}/>
     </div>
     
     <div style={{ marginLeft:  250 }}>请输入B选项
         {/* 选项 */}
      <TextArea rows={2} type="text" value={this.state.B} onChange={this.handleB}/>
     </div>
     
     <div style={{ marginLeft:  250 }}>请输入C选项
         {/* 选项 */}
      <TextArea rows={2} type="text" value={this.state.C} onChange={this.handleC}/>
     </div>
     
     <div style={{ marginLeft:  250 }}>请输入D选项
         {/* 选项 */}
      <TextArea rows={2} type="text" value={this.state.D} onChange={this.handleD}/>
     </div>
